...
class SingleInstanceException(BaseException):   # noqa: D101
    pass


class SingleInstance(object):   # noqa: D101,D102,D103
    """Class that can be instantiated only once per machine.
    ...
    def __init__(self, flavor_id="", lockfile=""):  # noqa: D107
...
class testSingleton(unittest.TestCase):  # noqa: D101,D102

    def test_1(self):   # noqa: D102
        me = SingleInstance(flavor_id="test-1")
        del me  # now the lock should be removed
        assert True

    def test_2(self):   # noqa: D102
